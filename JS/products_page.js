...
filterWrapper.appendChild(filterCategoriesTitle);
filterWrapper.appendChild(productPage.renderFilter(categories, "category"));
...
filterWrapper.appendChild(filterCategoriesTitle);
filterWrapper.appendChild(productPage.renderFilter(subcategories, "subcategory"));
filtersContainer.appendChild(filterWrapper);
filter.appendChild(filtersContainer);
