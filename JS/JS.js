const productsList = [
  ...
  {
    name:
      "Suport din aluminiu PawHut pentru caine cu perete si inchidere mobila",
    price: 569.99,
    image:
  ...
  {
    name:
      "Hrana uscata pentru pisici Carnilove Fresh, Crap si Pastrav, Sterilised",
    price: 42.69,
    image:
  ...
  {
    name:
      "Asternut igienic pentru animale Peleti din paie naturale de grau, Agro Peleti",
    price: 13.54,
    image:
